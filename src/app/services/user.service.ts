...
export class UsuarioService {
    ...
    actualizaPassUsuario(idUser: any): Observable<any> {
        return this.httpClient.post(this.url+ '/contrasena?id=' + idUser, idUser, VM_HTTP_OPTIONS);
    }

    actualizarEstatusUsuario(idUser: any, urlChange: string) {
        return this.httpClient.post(this.url+ '/'+urlChange+'?id=' + idUser, idUser, VM_HTTP_OPTIONS);
    }
}
